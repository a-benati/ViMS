...
applycal(vis=calms,field=xcal,gaintable=[ktab,gtab_p2,gtab_a2,btab2,Ttab_sec,ptab_df2],parang=False, flagbackup=False)
...
gaincal(vis = calms, caltable = Ttab_pol, selectdata = True,\
    ...
    refant = ref_ant, gaintype = "T", calmode = "ap",uvrange='',\
    solnorm=False, gaintable = [ktab_pol, gtab_pol_p,gtab_a2,btab2,ptab_df2], append=False)
...
S=xyamb(xytab=ptab_xf, qu=(0.945,1.259) ,xyout=ptab_xfcorr)
