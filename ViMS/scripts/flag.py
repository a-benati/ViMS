...
def run(logger):
    ...
    try:
        ...
        stdout, stderr = utils.run_command(f"aoflagger -strategy /ViMS/ViMS/utils/firstpass_QUV.rfis\
                                        {cal_ms}")

        #FLAG SUMMARY
        flagdata(vis='/a.benati/lw/victoria/tests/flag/obs01_1662797070_sdp_l0-cal_copy.ms', mode='summary')

        utils.run_command('rm casa*.log')
